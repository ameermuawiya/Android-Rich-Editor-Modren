    ...
    private void init() {
        ...
        SimpleTarget myTarget = new SimpleTarget<Bitmap>() {
            ...
            public void onResourceReady(Bitmap bitmap, Transition<? super Bitmap> transition) {
                ...
                // Inline scaling logic for full screen preview without applying rounded corners
                int w = bitmap.getWidth();
                int h = bitmap.getHeight();
                if (w >= sWidth * 0.2) {
                    int newHeight = sWidth * h / w;
                    bitmap = Bitmap.createScaledBitmap(bitmap, sWidth, newHeight, true);
                }

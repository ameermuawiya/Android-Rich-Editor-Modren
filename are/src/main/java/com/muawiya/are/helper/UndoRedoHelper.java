package com.muawiya.are.helper;
...
public class UndoRedoHelper {
    ...
    private Object cloneSpan(Object original) {
        ...
        try {
            ...
            if (original instanceof com.muawiya.are.spans.AreBoldSpan) {
                return new com.muawiya.are.spans.AreBoldSpan();
            }
            if (original instanceof com.muawiya.are.spans.AreItalicSpan) {
                return new com.muawiya.are.spans.AreItalicSpan();
            }
            if (original instanceof com.muawiya.are.spans.AreUnderlineSpan) {
                return new com.muawiya.are.spans.AreUnderlineSpan();
            }
            if (original instanceof com.muawiya.are.spans.AreSubscriptSpan) {
                return new com.muawiya.are.spans.AreSubscriptSpan();
            }
            if (original instanceof com.muawiya.are.spans.AreSuperscriptSpan) {
                return new com.muawiya.are.spans.AreSuperscriptSpan();
            }
            if (original instanceof com.muawiya.are.spans.ListBulletSpan) {
                return new com.muawiya.are.spans.ListBulletSpan();
            }
            if (original instanceof com.muawiya.are.spans.ListNumberSpan) {
                return new com.muawiya.are.spans.ListNumberSpan(((com.muawiya.are.spans.ListNumberSpan) original).getNumber());
            }
            if (original instanceof com.muawiya.are.spans.AreForegroundColorSpan) {
                return new com.muawiya.are.spans.AreForegroundColorSpan(((com.muawiya.are.spans.AreForegroundColorSpan) original).getForegroundColor());
            }
            if (original instanceof com.muawiya.are.spans.AreFontSizeSpan) {
                return new com.muawiya.are.spans.AreFontSizeSpan(((com.muawiya.are.spans.AreFontSizeSpan) original).getSize());
            }
            if (original instanceof com.muawiya.are.spans.AreUrlSpan) {
                return new com.muawiya.are.spans.AreUrlSpan(((com.muawiya.are.spans.AreUrlSpan) original).getURL());
            }
            if (original instanceof com.muawiya.are.spans.AreQuoteSpan) {
                try {
                    java.lang.reflect.Field field = com.muawiya.are.spans.AreQuoteSpan.class.getDeclaredField("mQuoteColor");
                    field.setAccessible(true);
                    int color = (int) field.get(original);
                    return new com.muawiya.are.spans.AreQuoteSpan(color);
                } catch (Exception e) {
                    return new com.muawiya.are.spans.AreQuoteSpan();
                }
            }
            if (original instanceof com.muawiya.are.spans.AreHrSpan) {
                return new com.muawiya.are.spans.AreHrSpan();
            }
            if (original instanceof com.muawiya.are.spans.AreMentionSpan) {
                return new com.muawiya.are.spans.AreMentionSpan(((com.muawiya.are.spans.AreMentionSpan) original).getMentionItem());
            }
            if (original instanceof com.muawiya.are.spans.AreImageSpan) {
                com.muawiya.are.spans.AreImageSpan img = (com.muawiya.are.spans.AreImageSpan) original;
                if (img.getUri() != null) {
                    return new com.muawiya.are.spans.AreImageSpan(mTextView.getContext(), img.getUri());
                } else if (img.getURL() != null) {
                    return new com.muawiya.are.spans.AreImageSpan(mTextView.getContext(), img.getDrawable(), img.getURL());
                } else if (img.getResId() != 0) {
                    return new com.muawiya.are.spans.AreImageSpan(mTextView.getContext(), img.getResId());
                }
            }
            if (original instanceof com.muawiya.are.spans.AreVideoSpan) {
                com.muawiya.are.spans.AreVideoSpan vid = (com.muawiya.are.spans.AreVideoSpan) original;
                ...
                return new com.muawiya.are.spans.AreVideoSpan(mTextView.getContext(), bitmap, vid.getVideoPath(), vid.getVideoUrl());
            }

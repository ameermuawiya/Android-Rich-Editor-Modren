...
import com.muawiya.are.colorpicker.ColorPickerListener;
import com.muawiya.are.colorpicker.ColorPickerView;
import com.muawiya.are.styles.ARE_Alignment;
import com.muawiya.are.styles.ARE_Mention;
import com.muawiya.are.styles.ARE_BackgroundColor;
import com.muawiya.are.styles.ARE_Bold;
import com.muawiya.are.styles.ARE_ClearFormat;
import com.muawiya.are.styles.ARE_FontColor;
import com.muawiya.are.styles.ARE_FontSize;
import com.muawiya.are.styles.ARE_Fontface;
import com.muawiya.are.styles.ARE_Hr;
import com.muawiya.are.styles.ARE_Image;
import com.muawiya.are.styles.ARE_IndentLeft;
import com.muawiya.are.styles.ARE_IndentRight;
import com.muawiya.are.styles.ARE_Italic;
import com.muawiya.are.styles.ARE_Link;
import com.muawiya.are.styles.ARE_ListBullet;
import com.muawiya.are.styles.ARE_ListNumber;
import com.muawiya.are.styles.ARE_Quote;
import com.muawiya.are.styles.ARE_ShowSource;
import com.muawiya.are.styles.ARE_Strikethrough;
import com.muawiya.are.styles.ARE_Subscript;
import com.muawiya.are.styles.ARE_Superscript;
import com.muawiya.are.styles.ARE_ToggleToolbar;
import com.muawiya.are.styles.ARE_Underline;
import com.muawiya.are.styles.ARE_Video;
...
public class ARE_Toolbar extends LinearLayout {
            ...
            if (REQ_IMAGE == requestCode) {
                ...
                if (uri != null) {
                    if (mEditText.getImageStrategy() != null && mImageStyle.shouldUploadSelectedImage()) {
                        ...
                        mImageStyle.insertImage(uri, com.muawiya.are.spans.AreImageSpan.ImageType.URI);
                    }
                }
    ...
    */
    public void applyDynamicThemeColor() {
        int bgColor = com.muawiya.are.Constants.getToolbarBackgroundColor(mContext);

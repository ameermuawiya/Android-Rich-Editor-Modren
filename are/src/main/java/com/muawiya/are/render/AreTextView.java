package com.muawiya.are.render;
...
import com.muawiya.are.strategies.defaults.DefaultClickStrategy;
...
public class AreTextView extends MaterialTextView {
        ...
        scaleDetector = new ScaleGestureDetector(context, new ScaleGestureDetector.SimpleOnScaleGestureListener() {
            ...
            public boolean onScale(ScaleGestureDetector detector) {
                try {
                    ...
                    com.muawiya.are.spans.AreFontSizeSpan.sCurrentScaleFactor = scaleFactor;
    ...
    private Spanned getSpanned(String html) {
        try {
            ...
            Spanned spanned = Html.fromHtml(html, Html.FROM_HTML_MODE_COMPACT, imageGetter, tagHandler);
            ...
            if (spanned instanceof Spannable) {
                ...
                for (android.text.style.QuoteSpan span : quoteSpans) {
                    ...
                    spannable.setSpan(new com.muawiya.are.spans.AreQuoteSpan(dynamicQuoteColor), start, end, flags);
                }

...
public class AreUrlDrawable extends BitmapDrawable {
    ...
    public AreUrlDrawable(Context context) {
        ...
        defaultDrawable = context.getResources().getDrawable(R.drawable.ic_downloading);
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
        BitmapFactory.decodeResource(this.mContext.getResources(), R.drawable.ic_broken_image, options);
